...
gameover = pygame.image.load("/Users/amirdank/Desktop/PP2/lab_9/snake/gameover.jpg")
...
class Food:
    ...
    def draw2(self):
        ...
        self.y = randrange(0, h, step)
        self.r = randint(1,2)
        self.image = pygame.image.load(f'/Users/amirdank/Desktop/PP2/lab_9/snake/food{self.r}.png')
...
class Snake:
    ...
    def collide_food(self, f:Food):
        if self.body[0][0] == f.x and self.body[0][1] == f.y: # если координаты головы змейки совпадают с координатами еды
            self.score += f.r
            pygame.mixer.Sound('/Users/amirdank/Desktop/PP2/lab_9/snake/eat.mp3').play()
            global flag
            flag = True
    ...
    def self_collide(self):
        ...
        if self.body[0] in self.body[1:]: # если голова змейки и входит в массив координат тела змейки
            ...
            pygame.mixer.Sound('/Users/amirdank/Desktop/PP2/lab_9/snake/gameover.wav').play()
            pygame.mixer.music.stop()
...
class Wall:
    def __init__(self, x, y):
        self.x, self.y = x, y
        self.pic = pygame.image.load("/Users/amirdank/Desktop/PP2/lab_9/snake/239enh3j3hdb.ZzJkp.jpg")
...
s = Snake()
f = Food(pygame.image.load(f'/Users/amirdank/Desktop/PP2/lab_9/snake/food{randint(1,2)}.png'))
disappear(5000)
...
while is_running:
    ...
    my_walls = open(f'/Users/amirdank/Desktop/PP2/lab_9/snake/wall{level}.txt', 'r').readlines() # читает каждую линию как отдельный лист
    walls = []
    ...
    if s.score >= 3:
        pygame.mixer.Sound('/Users/amirdank/Desktop/PP2/lab_9/snake/lvlup.mp3').play()
    ...
    for wall in walls:
        ...
        if s.body[0][0] == wall.x and s.body[0][1] == wall.y: # останавливаем игру, если голова змейки столкнеться со стенкой
            lose = True
            pygame.mixer.music.stop()
            pygame.mixer.Sound('/Users/amirdank/Desktop/PP2/lab_9/snake/gameover.mp3').play()
            pygame.mixer.music.stop()
