...
gameover = pygame.image.load("/Users/amirdank/Desktop/PP2/lab8/snake/gameover.jpg")
...
class Food:
    def __init__(self):
        ...
        self.pic = pygame.image.load("/Users/amirdank/Desktop/PP2/lab8/snake/png-transparent-apple-pencil-teacher-turnip-love-food-heart_e3TeU-transformed.png")
...
class Snake:
    ...
    def collide_food(self, f:Food):
        if self.body[0][0] == f.x and self.body[0][1] == f.y: # если координаты головы змейки совпадают с координатами еды
            self.score += 1
            pygame.mixer.Sound('/Users/amirdank/Desktop/PP2/lab8/snake/eat.mp3').play()
    ...
    def self_collide(self):
        ...
        if self.body[0] in self.body[1:]: # если голова змейки и входит в массив координат тела змейки
            ...
            pygame.mixer.Sound('/Users/amirdank/Desktop/PP2/lab8/snake/gameover.mp3').play()
            pygame.mixer.music.stop()
...
class Wall:
    def __init__(self, x, y):
        self.x, self.y = x, y
        self.pic = pygame.image.load("/Users/amirdank/Desktop/PP2/lab8/snake/239enh3j3hdb.ZzJkp.jpg")
...
while is_running:
    ...
    my_walls = open(f'/Users/amirdank/Desktop/PP2/lab8/snake/wall{level}.txt', 'r').readlines() # читает каждую линию как отдельный лист
    walls = []
    ...
    if s.score == 3:
        pygame.mixer.Sound('/Users/amirdank/Desktop/PP2/lab8/snake/lvlup.mp3').play()
